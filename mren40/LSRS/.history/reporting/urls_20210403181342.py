...
urlpatterns += [path("report8_restaurant_impact_on_category_sales/", report8.HolidayList.as_view(), name="holiday")]

urlpatterns += [path("report9_advertising_campaign_analysis/", holiday.HolidayList.as_view(), name="holiday")]
